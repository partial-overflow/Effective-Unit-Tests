package com.effective.unit.tests.service.item4;
...
public class Item4UserService {
    ...
    public CreateUserProfileResponse create(CreateUserProfileRequest createUserProfileRequest) {
        ...
        createUserProfileRequest.setEmailAddress(createUserProfileRequest.getEmailAddress() + "SuffixThatShouldntBeHere"); //defect
